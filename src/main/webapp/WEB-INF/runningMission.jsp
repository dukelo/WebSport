    ...
    <section class="mt-3">
        ...
        <div class="container" id="mission">
            <div style="text-align: center;">
                <h4 class="fw-bolder mt-4 mb-4 border border-dark">Running Mission</h4>
            </div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-5">
                    ...
                    <form action="/websport/hiking/mission/join" method = "get">
                    	...
                    	<input id="mhid" type="hidden" readonly="readonly" name="mHid" value="${mRid}" >
                ...
                <div class="col-7">
                    ...
                    <div class="mb-3" style="text-align: center;">
                        <img src="/websport/running/image/${rImage}" alt="" style="object-fit: cover; width: 100%;">
                    </div>
        ...
        <div class="container position-relative">
            ...
            <div id="uMissionDiscuss" class="container position-absolute top-0 start-50 translate-middle-x w-75 bg-light border border-dark">
                ...
                <div class="mb-4">
                <form action="/websport/member/running/mission/discuss/update" method = "Post">
                
                	<input id="mhid" type="hidden" readonly="readonly" name="umRid" value="${mRid}" >
                
                    <div class="mb-3 w-100  text-center">
                        <textarea class="form-control border" id="mClass" rows="10" name="umRDoc"></textarea>
                    </div>
    ...
    <script type="text/javascript">
  	$(function(){
  		$.ajax({
  			type:"post",
  			dataType:"JSON",
  			url:"/websport/member/running/mission/discuss/"+${mRid},
  							...
  							var content =
  				                `<div>
		  		                    <div class="row justify-content-center">
		  		                        <div class="col">
		  		                            <div class="mb-3 border-end text-center">
		  		                                <img src="/websport/running/mission/discuss/userphoto/`+n.name+`" alt="" style="object-fit: cover;height: 30;">
		  		                            </div>
